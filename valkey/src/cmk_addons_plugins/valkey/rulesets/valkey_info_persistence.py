...
def _parameter_form_valkey_info_persistence():
    return Dictionary(
        elements={
...
rule_spec_valkey_info_persistence = CheckParameters(
    name="valkey_info_persistence",
    title=Title("Valkey persistence"),
    topic=Topic.APPLICATIONS,
    parameter_form=_parameter_form_valkey_info_persistence,
    condition=HostAndItemCondition(item_title=Title("Valkey server name")),
)
