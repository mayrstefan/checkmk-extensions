...
def _parameter_form_valkey_info_clients():
    return Dictionary(
        elements={
...
rule_spec_valkey_info_clients = CheckParameters(
    name="valkey_info_clients",
    title=Title("Valkey clients"),
    topic=Topic.APPLICATIONS,
    parameter_form=_parameter_form_valkey_info_clients,
    condition=HostAndItemCondition(item_title=Title("Valkey clients")),
)
