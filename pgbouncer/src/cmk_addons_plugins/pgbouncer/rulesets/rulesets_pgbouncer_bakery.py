    ...
    return Dictionary(
        elements={
            ...
            "instance_username": DictElement(
                parameter_form=String(title=Title("Instance username"))
            ),
            "instance_pgpass_filepath": DictElement(
                parameter_form=String(title=Title("Path to .pgpass file"))
            ),
        }
    )
...
def _parameter_form_pgbouncer_bakery() -> Dictionary:
    return Dictionary(
        ...
        elements={
                    ...
                    elements={
                        ...
                        "instances": DictElement(
                            parameter_form=List(
                                ...
                                remove_element_label=Label(
                                    "Remove instance to be monitored"
                                ),
                            )
                        ),
                    },
            ...
            "dbuser": DictElement(parameter_form=String(title=Title("DB username"))),
            "pghost": DictElement(
                parameter_form=String(title=Title("DB Host or Socket directory"))
            ),
            "pgport": DictElement(parameter_form=String(title=Title("DB Port"))),
